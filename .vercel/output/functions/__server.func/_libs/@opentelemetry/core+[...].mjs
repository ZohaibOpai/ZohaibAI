...
import { n as require_src$1 } from "../@ai-sdk/react+[...].mjs";
...
function parsePairKeyValue(entry) {
	...
	let metadata;
	if (metadataSeparatorIndex !== -1 && metadataSeparatorIndex < entry.length - 1) metadata = (0, import_src$1.baggageEntryMetadataFromString)(entry.substring(metadataSeparatorIndex + 1));
	return {
		key,
		value,
		metadata
